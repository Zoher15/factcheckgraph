#!/bin/bash
#SBATCH -J pipeline_shortest_path_ffcg
#SBATCH -p general
#SBATCH -o pipeline_shortest_path_ffcg_%j.txt
#SBATCH -e pipeline_shortest_path_ffcg_%j.err
...
################################################################
errcho fetching
time python fetch_fred.py -ft ffcg -cpu 48
################################################################
errcho compiling
...
time python create_leave1out.py -fc fred -ft ffcg_co -cpu 48
################################################################

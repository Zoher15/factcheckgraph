...
def create_backbone(graph_path,fcg_class,fcg_label,kg_type):
	...
	if os.path.exists(intersect_path):
		...
		intersect_entities=np.loadtxt(intersect_path,encoding='utf-8')
		...
		bbg_label="{}_bb{}{}".format(fcg_label,kg_type[0],fcg_class[0])
		bbg_path=os.path.join(graph_path,"backbone-{}-{}".format(kg_type,fcg_class),bbg_label)

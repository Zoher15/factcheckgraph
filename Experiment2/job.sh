...
time klinker linkpred TFCG_co/TFCG_co_uris.txt TFCG_co/TFCG_co_edgelist.npy TFCG_co/Intersect_all_pairs_TFCG_co_IDs.txt TFCG_co/Intersect_all_pairs_TFCG_co_IDs.json -u -n 12 -w logdegree
time klinker linkpred FFCG_co/FFCG_co_uris.txt FFCG_co/FFCG_co_edgelist.npy FFCG_co/Intersect_all_pairs_FFCG_co_IDs.txt FFCG_co/Intersect_all_pairs_FFCG_co_IDs.json -u -n 12 -w logdegree

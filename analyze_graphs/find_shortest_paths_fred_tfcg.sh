...
time python find_shortest_paths.py -st tfcg -ft tfcg -mp roberta-base-nli-stsb-mean-tokens -cpu 48 -n 100
time python find_shortest_paths.py -st tfcg -ft ffcg -mp roberta-base-nli-stsb-mean-tokens -cpu 48 -n 100
time python order_paths.py -fcg fred -ft tfcg
################################################################
errcho plot graphs 
cd /geode2/home/u110/zkachwal/BigRed3/factcheckgraph/plot_graphs/
time python plot_sp.py -fcg fred -ft tfcg -pt roc -pr n100
time python plot_sp.py -fcg fred -ft tfcg -pt dist -pr n100

...
def create_ordered_paths(graph_path,mode):
	...
	rw_path=os.path.join(graph_path,"co-occur","paths2","paths_{}".format(mode))
...
def source_target(rdf_path,graph_path,embed_path,source_fcg_type,target_fcg_type):
	source_fcg_path=os.path.join(graph_path,"co-occur",source_fcg_type)
	...
	target_fcg_path=os.path.join(graph_path,"co-occur",target_fcg_type)
...
'''
def shortest_paths(rdf_path,model_path,graph_path,embed_path,source_fcg_type,target_fcg_type):
	...
	write_path=os.path.join(graph_path,"co-occur","paths2","paths")
	...
	for claimID in list(edges_of_interest.keys()):
		...
		nx.write_edgelist(source_fcg,os.path.join(source_fcg_path,"graphs2","{}.edgelist".format(name)))
...
if __name__== "__main__":
	...
	shortest_paths(args.rdfpath,"roberta-base-nli-stsb-mean-tokens",args.graphpath,args.embedpath,"tfcg_co",args.fcgtype+"_co")
	# shortest_paths(args.rdfpath,args.modelpath,args.graphpath,args.embedpath,"tfcg_co",args.fcgtype+"_co")

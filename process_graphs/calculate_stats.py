...
def calculate_stats(graph_path,graph_class,graph_type):
	#creating appropritate graph headers
	if graph_class=="co-occur":
		graph_type=graph_type+"_co"
	elif graph_class=="backbone":
		graph_type=graph_type+"_bb"
	#Rows of interests
...
if __name__== "__main__":
	...
	parser.add_argument('-gt','--graphtype', metavar='graph type',type=str,choices=['tfcg','ffcg','ufcg','wikipedia','dbpedia'],help='True False or Union FactCheckGraph')
